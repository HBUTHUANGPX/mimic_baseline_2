...
from . import agents, rough_env_cfg, flat_env_cfg

##
# Register Gym environments.
##
gym.register(
    id="GMT-Tracking-Rough-G1-v0",
...
gym.register(
    id="GMT-Tracking-Rough-G1-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="GMT-Tracking-Flat-G1-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
